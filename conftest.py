...
def app(request):
    ...
    if fixture == None or not fixture.is_valid():
        fixture = Application(browser=browser, base_url=web_conf['baseUrl'])
    fixture.session.ensure_login(username=web_conf['user'], password=web_conf['password'])
    return fixture
