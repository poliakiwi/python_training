...
def test_add_contact(app):
    ...
    app.contacts.fill_contact(Contact(fir="fir1", mid="mid1", las="las1", nic="nic1", tit="tit1", com="com1", add_1="add1",
...
def test_add_empty_contact(app):
    app.session.login(username="admin", password="secret")
    app.contacts.fill_contact(Contact(fir="", mid="", las="", nic="", tit="", com="", add_1="",
